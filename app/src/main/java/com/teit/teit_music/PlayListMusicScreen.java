...
public class PlayListMusicScreen extends Activity {
    //declare our widgets =>
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(PlayListMusicScreen.this, Playlist.class);
        String playlist_name = getIntent().getStringExtra("playlistname");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get our dataBase =>
        dataBaseHelp = new DataBaseHelp(PlayListMusicScreen.this);
        ...
        //now we should get oyr list database =>
        //we should work with our database =>
        dataBasePlayList =  new DataBasePlayList(PlayListMusicScreen.this);

        //create arraylist where we will get all records from our lovely database =>
        ArrayList<String> namePlaylistSongs = new ArrayList<>();

        //Should get all records inside =>
        dataBasePlayList.getAllRecords(namePlaylistSongs , playlist_name);


        //height of user screen =>
        DisplayMetrics metrics = PlayListMusicScreen.this.getResources().getDisplayMetrics();
        ...
        for(int i=0; i<nameFavoriteSongs.size();i++){
            if(music.getName().equals(nameFavoriteSongs.get(i))){
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            @Override
            public void run() {
                PlayListMusicScreen.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    public void MusicSet(File musicnew) {
        ...
        mediaMetadataRetriever.setDataSource(PlayListMusicScreen.this, uriMusic);
